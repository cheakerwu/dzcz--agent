...
const zh: Dict = {
  ...
  'task.no_tasks_hint': '在对话中告诉 Local Agent Terminal 创建定时任务',
  'task.loading': '加载中...',
  'task.name': '任务名称',
...
const en: Dict = {
  ...
  'skill.search': 'Search',
  'skill.search_hint': '💡 Skills are extensible modules that help Local Agent Terminal handle PDF processing, video downloads, image editing and more. Search by keyword and click "Install" to use.',
  ...
  'task.no_tasks_hint': 'Ask Local Agent Terminal to create a scheduled task',
