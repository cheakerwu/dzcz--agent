...
const zh: Dict = {
  ...
  'skill.search': '搜索',
  'skill.search_hint': '💡 Skill 是可扩展的执行能力模块，可以帮助点之出众完成商家运营、网页自动化、文件处理、数据核查等内部任务。输入关键词搜索，选择合适的 Skill 点击"安装"即可使用。',
  ...
  'task.no_tasks_hint': '在对话中告诉 点之出众 创建定时任务',
  'task.loading': '加载中...',
  'task.name': '任务名称',
...
const en: Dict = {
  ...
  'skill.search': 'Search',
  'skill.search_hint': '💡 Skills are extensible modules that help 点之出众 handle PDF processing, video downloads, image editing and more. Search by keyword and click "Install" to use.',
  ...
  'task.no_tasks_hint': 'Ask 点之出众 to create a scheduled task',
