          ...
          <div style={{ 
            ...
            <div>
              <div style={{ color: 'var(--settings-text)', fontWeight: '600', marginBottom: '4px' }}>
                {lang === 'zh' ? '🔑 准备模型服务 API Key' : '🔑 Prepare a Model API Key'}
              </div>
              <div style={{ lineHeight: '1.8' }}>
                {lang === 'zh' ? (
                  <>
                    1. 准备 OpenAI-compatible、Qwen、Anthropic 或其他模型服务的 API Key<br/>
                    2. 在「模型配置」里选择对应提供商，或选择「自定义」填写 Base URL<br/>
                    3. 粘贴 API Key 并保存<br/>
                    4. 发送一条消息验证模型是否可用
                  </>
                ) : (
                  <>
                    1. Prepare an API key from an OpenAI-compatible, Qwen, Anthropic, or other model service<br/>
                    2. Choose the matching provider in Model Settings, or use Custom and enter the Base URL<br/>
                    3. Paste the API key and save<br/>
                    4. Send a message to verify the model connection
                  </>
                )}
              </div>
            </div>
            ...
            <div style={{ marginLeft: '16px', marginTop: '4px' }}>
              {lang === 'zh' ? (
                <>
                  ...
                  • <strong>图片生成</strong>：支持 Gemini Image、GPT Image、Qwen 等可配置供应商<br/>
                  ...
                  • <strong>图片/视频分析</strong>：复用主模型配置，需使用支持视觉理解的模型<br/>
                ...
                <>
                  ...
                  • <strong>Image Generation</strong>: Supports configurable providers such as Gemini Image, GPT Image, and Qwen<br/>
                  ...
                  • <strong>Image/Video Analysis</strong>: Reuses the main model configuration and requires a vision-capable model<br/>
