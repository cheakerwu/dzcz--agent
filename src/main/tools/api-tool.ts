 ...
 * API 工具（系统配置访问）
 * 
 * 让 Agent 可以访问 Local Agent Terminal 的系统配置，包括：
...
export const apiToolPlugin: ToolPlugin = {
  metadata: {
    ...
    name: '系统配置 API',
    version: '1.0.0',
    description: '访问 Local Agent Terminal 系统配置。支持查询和设置工作目录、模型、工具等配置',
  ...
  create: (options: ToolCreateOptions) => {
    ...
    return [
      // 获取配置
      {
        ...
        label: '获取系统配置',
        description: '查询 Local Agent Terminal 的系统配置，包括工作目录、模型、工具等配置',
      ...
      //   label: '设置工作目录配置',
      //   description: '更新 Local Agent Terminal 的工作目录配置。可以设置工作目录、脚本目录、Skill 目录、图片目录、记忆目录',
      ...
      //   label: '设置模型配置',
      //   description: '更新 Local Agent Terminal 的模型配置。可以设置提供商、模型、API 地址、API Key',
      ...
      // 审核配对请求
      {
        ...
        label: '审核配对请求',
        description: '批准用户的配对请求。审核通过后，用户可以通过连接器与 Local Agent Terminal 进行私聊',
