...
import { AgentRuntime } from '../../domains/agent-runtime/index';
...
import { setGatewayInstance } from '../../domains/tools/scheduled-task-tool';
import { setLoadingStatusWindow } from '../utils/loading-status';
import type { GatewayMessage } from '../../../types/connector';
import { ConnectorManager } from '../../domains/connectors/connector-manager';
import { FeishuConnector } from '../../domains/connectors/feishu/feishu-connector';
import { SessionManager } from '../../domains/sessions/session-manager';
...
export class Gateway {
  ...
  constructor() {
    ...
    const { WecomConnector } = require('../../domains/connectors/wecom/wecom-connector');
    ...
    const { WechatConnector } = require('../../domains/connectors/wechat/wechat-connector');
    ...
    const { SmartKfConnector } = require('../../domains/connectors/smart-kf/smart-kf-connector');
  ...
  async initializeForWebMode(virtualWindow: any): Promise<void> {
    ...
    const { TIMEOUTS } = await import('../config/constants/timeouts');
